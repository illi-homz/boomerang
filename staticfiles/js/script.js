...
testWebP(function (support) {
  support == true ? document.querySelector('body').classList.add('webp') : document.querySelector('body').classList.add('no-webp');
});
;
...
gz.popup = {
  ...
  open(popup) {
    ...
    typeof popup === 'string' ? $popup = $(".".concat(popup)).addClass('open') : $popup = popup.addClass('open'); // Close on click outside
...
gz.header = {
  ...
  toggleTheme() {
    // console.log('sdss');
    var rootAttr = document.documentElement.getAttribute('theme');
    console.log('rootAttr', rootAttr);
    var isLight = rootAttr === 'light';
...
gz.indexServices = {
  ...
  changeSlideData() {
    ...
    $('._index-services__to-article').attr('href', url);
  }
...
gz.aboutArsenal = {
  ...
  sliderInit() {
    var arsenalLength = $('._about-arsenal__item').length;
  ...
  showMoreItems() {
    ...
    $("._about-arsenal__item:nth-child(n + ".concat(this.items, ")")).css('display', 'none');
    var itemCounter = 0;
    var $items = $("._about-arsenal__item");
    $items.each((i, el) => {
      if (el.style.display === 'block') itemCounter++;
    });
    if (itemCounter >= $items.length) $('._about-arsenal__show-more').css('display', 'none');
  }
...
gz.aboutClients = {
  ...
  sliderInit() {
    var clientsLength = $('._about-clients__item').length;
  ...
  showMoreItems() {
    ...
    $("._about-clients__item:nth-child(n + ".concat(this.items, ")")).css('display', 'none');
    var itemCounter = 0;
    var $items = $("._about-clients__item");
    $items.each((i, el) => {
      if (el.style.display === 'flex') itemCounter++;
    });
    if (itemCounter >= $items.length) $('._about-clients__show-more').css('display', 'none');
  }
...
gz.aboutGalery = {
  ...
  showMoreItems() {
    ...
    $("._about-galery ._about-galery__img:nth-child(n + ".concat(this.items, ")")).css('display', 'none');
    var itemCounter = 0;
    var $items = $("._about-galery ._about-galery__img");
    $items.each((i, el) => {
      if (el.style.display === 'flex') itemCounter++;
    });
