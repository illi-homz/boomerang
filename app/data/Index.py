    ...
    'RU': {
        **global_data['RU'],
        ...
        'services': {
            ...
            'desc': 'Группа охранных предприятий "Бумеранг" прочно обосновалась на рынке предоставления охранных услуг, более чем двадцатилетнюю работу создало себе имидж надежного, высокоинтеллектуального охранного предприятия.',
        ...
        'about': {
            'title': 'о нас',
            'text_list': [
                'Группа охранных предприятий "Бумеранг" прочно обосновалась на рынке предоставления охранных услуг, более чем двадцатилетнюю работу создало себе имидж надежного, высокоинтеллектуального охранного предприятия.',
    ...
    'EN': {
        **global_data['EN'],
        ...
        'about': {
            'title': 'about us',
            'text_list': [
                'The group of security companies "Boomerang" for more than twenty years of existence has created an image of a reliable, highly intelligent security company.',
